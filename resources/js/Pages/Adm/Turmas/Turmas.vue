                ...
                <table class="styled-table">
                    ...
                    <tbody v-for="turma in turmas">
                        <tr>
                            ...
                            <td style="color: #3065ac; font-weight: 700;"><Link :href="`/turmas/alunos/cadastrados/${turma.id}`">Ver</Link></td>
                            <td style="color: #3065ac; font-weight: 700;"><Link :href="`/turma/alunos/${turma.id}`">Adicionar aluno</Link></td>
